...
from utils.easy.base_utils import *
from utils.easy.file_utils import save_json, read_json
from utils.easy.camera_utils import read_cameras, Undistort, read_camera
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='data/renbody/0008_01')
    parser.add_argument('--out', type=str, default='neus2')
    parser.add_argument('--cameras_dir', type=str, default='aligned')
    parser.add_argument('--nframe', type=int, default=150)
    parser.add_argument('--interval', type=int, default=1)
    parser.add_argument('--mask_dir', type=str, default='masks')
    parser.add_argument('--image_dir', type=str, default='images_calib')
    parser.add_argument('--ratio', type=float, default=1.0)
    parser.add_argument('--skip_write_image', action='store_true', default=False)
    parser.add_argument('--offset', type=float, nargs=3, default=[0.5, 0.5, 0.5])
    ...
    cameras = read_camera(join(data, args.cameras_dir, 'intri.yml'), join(data, args.cameras_dir, 'extri.yml'))
