...
from os.path import join, exists, dirname, split, splitext, abspath, relpath, isdir, isfile, basename, getsize
...
from utils.easy.base_utils import default_dotdict, dotdict, DoNothing
...
# It's OK to just import most of the utility functions
from easyvolcap.utils.console_utils import *
from easyvolcap.utils.net_utils import load_pretrained

# fmt: off
our_args = patch_evc_args() # will handle sys.argv conversion for you

# Every imports that implicitly or explicitly uses the easyvolcap engine should be placed here after patching the arguments
from easyvolcap.engine import cfg
